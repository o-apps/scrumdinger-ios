...
/// Keeps time for a daily scrum meeting. Keeo track of the total meeting time, the time for each speaker, and the name of the current speaker.
class ScrumTimer: ObservableObject {
    ...
    struct Speaker: Identifiable {
        ...
        /// The attendee name.
        let name: String
        ///True if the attendee has competed ther turn to speak.
    ...
    /// A closure tht is executed when a new attendee begins speaking.
    ...
    private func changeToSpeaker(at index: Int) {
        ...
        // Terminates the operation in case of exausted all attendees
...
extension DailyScrum {
    /// A new 'ScrumTimer' using the meeting length and attenddes in the DailyScrum.
